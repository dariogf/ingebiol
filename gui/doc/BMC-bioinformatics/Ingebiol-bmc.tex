...
\title{Ingebiol: A flexible web interface generator for biological applications}
...
\author{Darío Guerrero\correspondingauthor$^{1,2}$%
       \email{Darío Guerrero\correspondingauthor - dariogf@scbi.uma.es}%
      \and
         Rocío Bautista\correspondingauthor$^1$%
         \email{Rocío Bautista\correspondingauthor - rociobm@scbi.uma.es}
       and 
         M. Gonzalo Claros$^1$%
         \email{M. Gonzalo Claros - claros@scbi.uma.es}%
      }
...
\address{%
    \iid(1)Plataforma Andaluza de Bioinformática, Universidad de Málaga, Severo Ochoa 34, 29590 Málaga, Spain%
